...
expName = 'freq_mismatch'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Code\\mismatch_negativity\\freq_mismatch_lastrun.py',
